...
int main() {
    return parse_and_writeback((const uint8_t *) MAPPING_PDU, sizeof(MAPPING_PDU)) +
        parse_and_writeback((const uint8_t *) WITHDRAWAL_PDU, sizeof(WITHDRAWAL_PDU));
}